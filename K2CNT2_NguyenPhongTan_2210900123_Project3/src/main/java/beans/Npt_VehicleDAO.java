...
public class Npt_VehicleDAO {
    public List<Npt_Vehicle> getAllVehicles() {
        List<Npt_Vehicle> list = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                Npt_Vehicle vehicle = new Npt_Vehicle(
    ...
    public void updateVehicle(Npt_Vehicle vehicle) {
        try {
            Connection conn = Npt_DBConnection.getConnection();
