...
public class Npt_RequestDAO {
    public List<Npt_Request> getAllRequests() {
        List<Npt_Request> list = new ArrayList<>();
        try {
            ...
            while (rs.next()) {
                Npt_Request request = new Npt_Request(
    ...
    public Npt_Request getRequestById(int requestId) {
        Npt_Request request = null;
        try {
            Connection conn = DBConnection.getConnection();
